...
class RollingNameSpace[T]:
    ...
    def mean(self) -> Iter[float]:
        ...
        [2.0, 3.0, 4.0]
        """
        return iter_factory(rolling.Mean(self._data, self._window))
    ...
    def median(self) -> Iter[T]:
        ...
        [2, 3, 4]
        """
        return iter_factory(rolling.Median(self._data, self._window))
    ...
    def sum(self) -> Iter[T]:
        ...
        [6.0, 9.0, 12.0]
        """
        return iter_factory(rolling.Sum(self._data, self._window))
    ...
    def min(self) -> Iter[T]:
        ...
        [1, 1, 1, 1, 2]
        """
        return iter_factory(rolling.Min(self._data, self._window))
    ...
    def max(self) -> Iter[T]:
        ...
        [4, 4, 5, 9, 9]
        """
        return iter_factory(rolling.Max(self._data, self._window))
    ...
    def var(self) -> Iter[float]:
        ...
        [2.33, 2.33, 3.0]
        """
        return iter_factory(rolling.Var(self._data, self._window))
    ...
    def std(self) -> Iter[float]:
        ...
        [1.53, 1.53, 1.73]
        """
        return iter_factory(rolling.Std(self._data, self._window))
    ...
    def kurtosis(self) -> Iter[float]:
        ...
        """
        return iter_factory(rolling.Kurtosis(self._data, self._window))
    ...
    def skew(self) -> Iter[float]:
        ...
        [0.94, 0.94, -1.73]
        """
        return iter_factory(rolling.Skew(self._data, self._window))
    ...
    def all(self) -> Iter[bool]:
        ...
        """
        return iter_factory(rolling.All(self._data, self._window))
    ...
    def any(self) -> Iter[bool]:
        ...
        [True, True, True, True]
        """
        return iter_factory(rolling.Any(self._data, self._window))
    ...
    def product(self) -> Iter[float]:
        ...
        [6.0, 24.0, 60.0]
        """
        return iter_factory(rolling.Product(self._data, self._window))
    ...
    def apply[R](self, func: Callable[[Iterable[T]], R]) -> Iter[R]:
        ...
        [2, 3, 3]
        """
        return iter_factory(rolling.Apply(self._data, self._window, "fixed", func))
    ...
    def apply_pairwise[R](
        ...
        """
        return iter_factory(
            rolling.ApplyPairwise(self._data, other, self._window, func)
        )
