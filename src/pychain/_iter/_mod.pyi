...
class IterConstructor:
    @overload
    def __call__(self) -> Iter[Any]: ...
    @overload
    def __call__[T](self, *dtype: type[Iterable[T]]) -> Iter[T]: ...
    def attr[T](self, name: str, dtype: type[Iterable[T]]) -> "Iter[T]": ...
    def item[T](self, key: Any, dtype: type[Iterable[T]]) -> "Iter[T]": ...

class Iter[V]:
    def __call__(self, value: Iterable[V]) -> Iterable[V]: ...
    def clone(self) -> Self: ...
