...
from typing import Any, Final, Self, TypeGuard, get_args, get_type_hints
...
class TypedLambda[P, R]:
    ...
    @staticmethod
    def identity(obj: Any) -> TypeGuard["TypedLambda[Any, Any]"]:
...
class FunctionDefFinder(ast.NodeVisitor):
    ...
    def visit_FunctionDef(self, node: ast.FunctionDef) -> Self:
