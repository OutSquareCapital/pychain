...
class BaseDict[KT, VT](UserDict[KT, VT]):
    """
    ...
    def compose(self, *funcs: Callable[[dict[KT, VT]], dict[KT, VT]]) -> Self:
        """Apply a pipeline of functions to the dict and return a new Dict.

        Example:
            >>> from ._lib import Dict
            >>> Dict({"a": 1}).compose(lambda d: d)
            {'a': 1}
        """
        return self.__class__(ft.pipe(self.data, *funcs))
    ...
    def select(self, predicate: fn.Check[KT]) -> Self:
        ...
        Example:
            ...
            {}
        """
        return self.__class__(dcz.keyfilter(predicate, self.data))
    ...
    def filter(self, predicate: fn.Check[VT]) -> Self:
        ...
        Example:
            ...
            {3: 4}
        """
        return self.__class__(dcz.valfilter(predicate, self.data))
    ...
    def filter_items(
        ...
        Example:
            ...
            {3: 4}
        """
        return self.__class__(dcz.itemfilter(predicate, self.data))
    ...
    def with_key(self, key: KT, value: VT) -> Self:
        ...
        Example:
            ...
            {'x': 1}
        """
        return self.__class__(dcz.assoc(self.data, key=key, value=value))
    ...
    def with_nested_key(self, keys: Iterable[KT] | KT, value: VT) -> Self:
        ...
        Example:
            ...
            {'a': {'b': 1}}
        """
        return self.__class__(dcz.assoc_in(self.data, keys=keys, value=value))
    ...
    def update_in(self, *keys: KT, f: fn.Process[VT]) -> Self:
        ...
        Example:
            ...
            {'a': {'b': 2}}
        """
        return self.__class__(dcz.update_in(self.data, keys=keys, func=f))
    ...
    def merge(self, *others: dict[KT, VT]) -> Self:
        ...
        Example:
            ...
            {1: 2, 3: 4}
        """
        return self.__class__(dcz.merge(self.data, *others))
    ...
    def merge_with(
        ...
        Example:
            ...
            {1: 3}
        """
        return self.__class__(dcz.merge_with(f, self.data, *others))
    ...
    def drop(self, *keys: KT) -> Self:
        ...
        Example:
            ...
            {3: 4}
        """
        return self.__class__(dcz.dissoc(self.data, *keys))
